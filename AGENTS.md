...
- The CI PRNs scenario uses a populated PRN response generated by
  [the backend-owned WireMock initialiser](https://github.com/DEFRA/waste-obligations/blob/main/compose/journey-tests/generate-wiremock-mappings.mjs). The scenario compares a visible row with a backend record (number, material,
  issuer and tonnage). Deployed test data must include a PRN awaiting acceptance
  for the journey producer. No acceptance or rejection is performed.
